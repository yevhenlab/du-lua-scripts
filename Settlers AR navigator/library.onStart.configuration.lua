...
showCurrentNodeChildren = true --export
showNearbyPlaces = false --export
...
SARNConfiguration = {
    ...
    showCurrentNodeChildren = showCurrentNodeChildren ~= false,
    showNearbyPlaces = showNearbyPlaces == true,
